...
const SHOPTYPES = {
  ...
  'Services': ['Apartment Rental', 'Bank', 'Barber', 'Car Rental', 'Computer Services', 'Delivery', 'Dry Cleaner',
    'Electronics Repair', 'Film Studio', 'Fitness', 'Funeral Services', 'Graphic Design', 'Hair Salon', 'Health Care', 'Hospital',
    'Jewelry Repair', 'Laundromat', 'Law Firm', 'Leather Repair', 'Library', 'Masseuse', 'Money Transfer', 'Nail Salon',
...
function setContent(pointInfo) {
  ...
  editButton.innerHTML = '<img class="icons" id="editBTN" src="./assets/pencil.png"/>'
